    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../admin/pasien/TambahPasien.php" method="post">
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class='d-flex align-items-center justify-content-center'>
                                            ...
                                            <a href='../admin/pasien/HapusPasien.php?id=<?php echo $row['id']; ?>'
                                            ...
                                            <div class='modal fade' id='myModal<?php echo $row['id']; ?>' role='dialog'
                                                ...
                                                <div class='modal-dialog'>
                                                    ...
                                                    <div class='modal-content'>
                                                        ...
                                                        <div class='modal-body'>
                                                            <form action="../admin/pasien/UpdatePasien.php" method="POST">
                                                                <input type="hidden" name="id" value="<?= $row['id']; ?>">
                                                                <div class="form-group">
                                                                    <label for="nama_pasien">Nama Pasien</label>
                                                                    <input type="text" class="form-control" id="nama_pasien"
                                                                        name="nama_pasien"
                                                                        value="<?php echo $row['nama_pasien'] ?>" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="alamat_pasien">Alamat</label>
                                                                    <input type="text" class="form-control"
                                                                        id="alamat_pasien" name="alamat_pasien"
                                                                        value="<?php echo $row['alamat_pasien'] ?>"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="no_ktp"
                                                                        name="no_ktp" value="<?php echo $row['no_ktp'] ?>"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="no_hp"
                                                                        name="no_hp" value="<?php echo $row['no_hp'] ?>"
                                                                        required>
                                                                </div>
                                                                <button type="submit"
