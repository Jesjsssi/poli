...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="../../../modules/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="src/components/main-content/MainContent.php" id="menuDashboard"
                                    class="nav-link active menu d-flex align-items-center" style="gap: 5px;">
                                    <i class="nav-icon fas fa-th "></i>
                                    <p>Dashboard</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="src/components/admin/dokter/dokter.php" id="menuDokter"
                                    class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                                    <i class="fas fa-solid fa-user-nurse nav-icon"></i>
                                    <p>Dokter</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="src/components/admin/obat/Obat.php" id="menuObat"
                                    class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                            ...
                            <li class="nav-item">
                                <a href="src/components/admin/pasien/pasien.php" id="menuPasien"
                                    class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                            ...
                            <li class="nav-item">
                                <a href="src/components/admin/poli/poli.php" id="menuPoli"
                                    class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="src/components/admin/dokter/dokter.php" id="menuPeriksa"
                                        class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                                        <i class="fas fa-solid fa-user-nurse nav-icon"></i>
                                        <p>Periksa</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="src/components/admin/dokter/dokter.php" id="menuJadwal"
                                        class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                                        <i class="fas fa-solid fa-clock nav-icon"></i>
                                        <p>Jadwal</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="src/components/admin/dokter/dokter.php" id="menuRiwayat"
                                        class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                                ...
                                <li class="nav-item">
                                    <a href="src/components/admin/dokter/dokter.php" id="menuProfil"
                                        class="nav-link menu d-flex align-items-center" style="gap: 5px;">
                                        <i class="fas fa-solid fa-user-nurse nav-icon"></i>
                                        <p>Profil</p>
                                    </a>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="src/components/pasien/index.php" id="menuProfil"
                                            class="nav-link menu d-flex align-items-center" style="gap: 5px;">
